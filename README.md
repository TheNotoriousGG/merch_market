...
При первом запуске local seed создаёт готовую демонстрационную витрину: категории,
товары и SKU, изображения, цены, остатки, акции, подборки и баннеры. В набор также
входит черновик товара для проверки админки; повторные запуски не создают дубликаты.
