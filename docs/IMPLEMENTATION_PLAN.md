...
Статус: блоки 1–5/12 завершены, выполняется блок 6/12. Подробное ТЗ находится в `docs/requirements/INVENTORY_VERTICAL_SLICE.md`, consistency boundary — в ADR-0007.
