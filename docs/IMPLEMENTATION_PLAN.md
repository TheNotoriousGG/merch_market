...
Статус: блоки 1–11/12 завершены, следующим разрешён блок 12/12. Подробное ТЗ находится в `docs/requirements/INVENTORY_VERTICAL_SLICE.md`, consistency boundary — в ADR-0007.
